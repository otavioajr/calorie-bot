...
const ImageMealItemSchema = z.object({
  ...
  nutrition_basis_calories: z.coerce.number().nonnegative().nullable().optional().default(null),
  nutrition_basis_protein: z.coerce.number().nonnegative().nullable().optional().default(null),
  nutrition_basis_carbs: z.coerce.number().nonnegative().nullable().optional().default(null),
  nutrition_basis_fat: z.coerce.number().nonnegative().nullable().optional().default(null),
